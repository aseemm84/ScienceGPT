...
NCERT curriculum for Grades 1-12. Data is owned here; never scattered elsewhere.
"""
...
class CurriculumData:
    """Manages NCERT curriculum data for Grades 1-12."""

    def __init__(self) -> None:
        self.languages: list[str] = list(LANG_MAP.keys())

        # {grade: {subject: [topics]}}
        self.curriculum: dict[int, dict[str, list[str]]] = {
            1: {
                "General Science": [
                    "Living and Non-living Things", "Plants", "Animals",
                    "Human Body", "Water", "Air",
                ],
                "Environmental Studies": [
                    "Family and Community", "Plants Around Us",
                    "Animal Habitats", "Water Sources",
                ],
            },
            2: {
                "General Science": [
                    "Food and Nutrition", "Weather", "Light and Shadow",
                    "Sound", "Materials",
                ],
                "Environmental Studies": [
                    "Travel and Transport", "Our Environment",
                    "Pollution", "Natural Resources",
                ],
            },
            3: {
                "General Science": [
                    "Motion", "Simple Machines", "Safety", "Human Body Systems",
                ],
                "Environmental Studies": [
                    "Weather and Climate", "Rocks and Minerals", "Soil",
                ],
            },
            4: {
                "General Science": [
                    "Force, Work, and Energy", "States of Matter",
                    "Adaptations in Animals",
                ],
                "Environmental Studies": [
                    "Our Environment and Pollution", "Conservation",
                ],
            },
            5: {
                "General Science": [
                    "The Circulatory System", "The Nervous System",
                    "Simple Machines", "Light and Shadows",
                ],
                "Environmental Studies": [
            ...
            7: {
                ...
                "Biology": [
                    "Nutrition in Plants and Animals", "Fibre to Fabric",
    ...
    def get_languages(self) -> list[str]:
        """Return supported display languages."""
        return self.languages

    def get_all_grades(self) -> list[int]:
        """Return sorted list of all grades."""
        return sorted(self.curriculum.keys())
    ...
    def get_topics_for_grade_subject(self, grade: int, subject: str) -> list[str]:
        """Return topics for a grade/subject pair."""
        return self.curriculum.get(grade, {}).get(subject, [])

    def is_valid_combination(self, grade: int, subject: str) -> bool:
        """Check that grade/subject is in the curriculum."""
        return subject in self.get_subjects_for_grade(grade)


@st.cache_resource
def get_curriculum() -> CurriculumData:
    """Singleton accessor — prevents re-instantiation on every rerun."""
